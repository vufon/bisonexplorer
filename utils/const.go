...
var AgendasDetail = map[string][]string{
	...
	"changesubsidysplit":   {"Change PoW/PoS Subsidy Split", "[[Proposal((https://proposals.decred.org/record/427e1d4))]] to modify to the block reward subsidy split such that 10%% goes to Proof-of-Work and 80%% goes to Proof-of-Stake."},
