...
function commaWithDecimal (val, decimal) {
...
function decimalParts (v, useCommas, precision, lgDecimals) {
...
function bytes (s) { // from go-humanize
...
function date (stamp, withTimezone, hideHisForMidnight) {
...
function hashElide (hash, link, asNode) {
