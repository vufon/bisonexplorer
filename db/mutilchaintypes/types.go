...
import (
	...
	"github.com/decred/dcrdata/v8/db/mutilchaintypes/mutilchaininternal"
)
...
func (a *UInt64Array) scanBytes(src []byte) error {
	elems, err := mutilchaininternal.ScanLinearArray(src, []byte{','}, "UInt64Array")
	if err != nil {
		return err
	}
